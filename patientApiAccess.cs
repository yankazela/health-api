...
namespace MyNamespace
{
    ...
    {
        private string _baseUrl = "https://patients.servicetrainer.dev/";
        ...
        public System.Threading.Tasks.Task<Patient> GetPatientAsync(string authorisation, int patientId)
        {
            return GetPatientAsync(authorisation, patientId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Patient> GetPatientAsync(string authorisation, int patientId, System.Threading.CancellationToken cancellationToken)
        {
            if (patientId == null)
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Patient> PutPatientAsync(string authorisation, Patient body, int patientId)
        {
            return PutPatientAsync(authorisation, body, patientId, System.Threading.CancellationToken.None);
        }
    ...
    public partial class Patient
    {
        ...
        [Newtonsoft.Json.JsonProperty("healthProfessionalIds", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<int> HealthProfessionalIds { get; set; }
